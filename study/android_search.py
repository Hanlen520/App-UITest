...
class Test(unittest.TestCase):
    ...
    def test_01(self):
        ...
        Swipe.resourceid_assert(u'搜索', search_button)

    def test_02(self):
        """输入内容，点击搜索按钮，进入搜索结果页面"""
        Swipe.resourceid_sendkeys(search_text, text)
        Swipe.resourceid_click(search_button)
        time.sleep(3)
        Swipe.resourceid_assert(u"火影忍者 2002", video_title)
