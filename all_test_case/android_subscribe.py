...
class Test(unittest.TestCase):
    ...
    def test_01(self):
        ...
        common.resourceid_click(tab_sub)
        time.sleep(3)

    def test_02(self):
        """点击进入主题管理页，点击看看推荐"""
        common.resourceid_click(sub_user_list)
        common.resourceid_assert(u"还没有订阅过主题哦~", list_empty)
        common.resourceid_click(list_empty_button)

    def test_03(self):
        """主题管理页，点击除订阅按钮外的区域，进入主题详情页"""
        common.resourceid_click(sub_button)
        common.resourceid_click(sub_user_list)
        common.resourceid_click(list_subject_title)
        common.resourceid_click(subject_detail_back)

    def test_04(self):
        """主题管理页，点击已订阅按钮，取消订阅，下拉刷新后在列表中移除"""
        common.resourceid_click(list_subscribe_button)
        common.resourceid_assert(u"订阅", list_subscribe_state)
        common.swipeDown(1000)
        common.resourceid_assert(u"还没有订阅过主题哦~", list_empty)
        common.classname_click(list_back)
